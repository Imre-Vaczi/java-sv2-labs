...
public class Danube extends River{
    ...
    public static void main(String[] args) {
        Water water = new Danube("Duna", 2850, Arrays.asList("Wien", "Bratislava", "Budpest", "Београд"));
        River river = new Danube("Duna", 2850, Arrays.asList("Wien", "Bratislava", "Budpest", "Београд"));
        Danube danube = new Danube("Duna", 2850, Arrays.asList("Wien", "Bratislava", "Budpest", "Београд"));

        System.out.println(river.getLength());
        System.out.println(river.getName());
        System.out.println(river.getClass());

        System.out.println(danube.capitals);
